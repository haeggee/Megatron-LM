"""AdEMAMix warmup schedulers and standalone AdEMAMix optimizer.

The warmup schedulers are used by the master optimizer; the ``AdEMAMix`` class
implements the standalone ``--optimizer ademamix``.
"""
