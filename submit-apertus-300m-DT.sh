...
#SBATCH --time=5:00:00
#SBATCH --job-name=apertus-300m-DiffAttention
...
#### Debugging ####
LOG_NCCL=info # Log NCCL_DEBUG=info. Every process will dump the logging into separate files, check `NCCL_DEBUG_FILE`
...
EXP_NAME=apertus-300m-DiffAttention-${SLURM_NNODES}n-${SEQ_LEN}sl-${GBS}gbsz
