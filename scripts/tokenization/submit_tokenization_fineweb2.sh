...
PATH_TO_PREPROCESSING_METADATA=/capstor/scratch/cscs/ctianche/swissai_long_context/data/final_tokenized/fineweb2/prepare/$DATASET_NAME
PATH_TO_DATATROVE_LOGGING_DIR=$MEGATRON_LM_DIR/logs/datatrove
PATH_TO_SLURM_LOGGING_DIR=$MEGATRON_LM_DIR/logs/slurm/tokenization-$TOKENIZER_NAME-fineweb2-$DATASET_NAME
PATH_TO_OUTPUT_FOLDER=/capstor/scratch/cscs/ctianche/swissai_long_context/data/final_tokenized/fineweb2

DATASET_OUTPUT_FOLDER_NAME=$PATH_TO_OUTPUT_FOLDER/$TOKENIZER_NAME/$DATASET_NAME
CSV_RESULTS_FILE=$PATH_TO_PREPROCESSING_METADATA/tokenize-$TOKENIZER_NAME-fineweb2-$DATASET_NAME.csv
...
for paths_file in "$PATH_TO_PREPROCESSING_METADATA/dumps"/*; do
  ...
  logging_dir=$PATH_TO_DATATROVE_LOGGING_DIR/$TOKENIZER_NAME/fineweb2_$DATASET_NAME/dump-$dump
