...
DATASET_NAME=swissai-fineweb-2_0_1-quality_10-filterrobots-rehydrated
COLUMN_KEY=text
...
PATH_TO_OUTPUT_FOLDER=/capstor/store/cscs/swissai/infra01/users/bmessmer/apertus-datasets/ # Where tokenized datasets are stored
