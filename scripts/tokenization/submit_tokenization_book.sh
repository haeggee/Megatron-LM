...
PATH_TO_PREPROCESSING_METADATA=/capstor/scratch/cscs/ctianche/swissai_long_context/data/final_tokenized/books/prepare
...
PATH_TO_OUTPUT_FOLDER=/capstor/scratch/cscs/ctianche/swissai_long_context/data/final_tokenized/books
